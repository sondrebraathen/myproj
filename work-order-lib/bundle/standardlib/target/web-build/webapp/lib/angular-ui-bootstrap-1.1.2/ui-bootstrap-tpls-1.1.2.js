          ...
          return function link(scope, element, attrs, tooltipCtrl) {
            ...
            function createTooltip() {
              ...
              tooltip = tooltipLinker(tooltipLinkedScope, function(tooltip) {
                if (appendToBody) {
                  // TODO-BMC: please see the issue https://github.com/angular-ui/bootstrap/issues/6120
                  // for the explanation of the following change
                  // removed line: $document.find('body').append(tooltip);
                  // added line: angular.element(document.body).append(tooltip);
